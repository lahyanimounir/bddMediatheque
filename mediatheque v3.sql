...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 31 mai 2021 à 19:41
...
INSERT INTO `doc` (`id`, `nbPages`, `titre`, `editeur`, `edition`, `isbn`, `url`, `type_doc`, `auteur`) VALUES
(1, 2, 'titreLivre', 'Soumya', 1, 'isbn', 'url', 'magasin', 'auteurs');
